...
export default function AvatarRight(props) {
    ...
    const createNFTByCoin = async () => {
      await props.createNFT(nameDino);
    };
      ...
      <div className="pickavt__body-right sm:xl:w-full xl:w-1/3">
        <div className="pickavt__body-right-body">
          <div className="pickavt__body-right-main">
            ...
            {props.loading ? (
              <div className="pickavt__img">
                <img src="https://media1.giphy.com/media/l3nWhI38IWDofyDrW/giphy.gif?cid=ecf05e47zr7d94pypd8djqw70zr5xvnbgbme1loqfuxdz6qe&rid=giphy.gif&ct=g" alt= "img"/>
              </div>
            ) : (
              <div className="pickavt__img">
                {props.preview ? (
          ...
          <div className="pickavt__right-btn">
            ...
            <span
              className={ "pickavt__right-btn-r active"
              }
              onClick={() => createNFTByCoin()}
            >
