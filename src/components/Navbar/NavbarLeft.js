...
import { GiSandsOfTime, GiTowerBridge } from "react-icons/gi";
...
.navbar__left-active {
  width: 56px;
  animation: navbar-hidden linear 0.4s;
  transition: width linear 0.4s;
  .nav-menu {
    width: 100%;
    transition: width linear 0.4s;
        ...
        <nav className={sidebar ? "nav-menu " : "nav-menu active"}>
          <ul className="nav-menu-items">
            ...
            >
              ...
              {show === "nft-show"&& statusMenu && <ul className="nav-menu_items nft">
                <li className="nav-menu__item">
