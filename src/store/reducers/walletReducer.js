...
const initialState = {
  ...
  contractEth: null,
  contractBsc: null,
  contractStakingETH: null,
  contractStakingBSC: null,
  account: null,
  balance: 0,
  network: "rinkeby",
  Body: [
...
function walletReducer(state = initialState, action) {
  ...
  switch (action.type) {
    case actionTypes.CONNECT_WALLET:
      ...
      copyState.contractEth = action.contractEth;
      copyState.contractBsc = action.contractBsc;
      copyState.contractStakingETH = action.contractStakingETH;
      copyState.contractStakingBSC = action.contractStakingBSC;
      return copyState;
    ...
    case actionTypes.GET_LIST_MARKET:
      console.log("co chay qua day", action.market);
      copyState.arrMarket = action.market;
      console.log("arrMarket", copyState.arrMarket);
      return copyState;

    case actionTypes.CHANGE_NETWORK:
      copyState.network = action.name;
      return copyState;
    default:
      return state;
  }
